...
const inputParams = ref("https://642541e49e0a30d92b2ccf2a.mockapi.io/Minhh")
...
const checkActive = (keys) => {
  if (keys.length > 0) {
    ...
    inputParams.value = `https://642541e49e0a30d92b2ccf2a.mockapi.io/Minhh?${params.slice(0, -1)}`
  } else {
    inputParams.value = "https://642541e49e0a30d92b2ccf2a.mockapi.io/Minhh"
  }
}
</script>
